...
class OberhausenCrawler(AbstractDataCrawler):

    def __init__(self):
        super().__init__("https://services7.arcgis.com/mOBPykOjAyBO2ZKk/arcgis/rest/services/RKI_Landkreisdaten/FeatureServer/0/query?objectIds=70&outFields=OBJECTID,cases7_per_100k,last_update,cases,deaths,recovered&returnGeometry=false&outSR=4326&f=json")
    ...
    def refresh(self) -> OverviewDataRow:
        ...
        entry = OverviewDataRow(location="oberhausen", incidence=attributes.get("cases7_per_100k", -1),
